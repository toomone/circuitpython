...
HID_DEVICE_DATA = {
    ...
    "SPACEMOUSE" : DeviceData(report_length=8, out_report_length=1, usage_page=0x01, usage=0x08),
...
def spacemouse_hid_descriptor(report_id):
    data = HID_DEVICE_DATA["SPACEMOUSE"]
    return hid.ReportDescriptor(
        description="SPACEMOUSE",
        report_descriptor=bytes(
